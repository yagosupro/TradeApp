...
public class TradeAdapter extends RecyclerView.Adapter<TradeAdapter.TradeViewHolder> {
    ...
    public void setOnTradeInfoClickListener(Consumer<Integer> onTradeInfoClickListener) {
        this.onTradeInfoClickListener = onTradeInfoClickListener;
    }
        ...
        public TradeViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onTradeInfoClickListener !=null){
                        onTradeInfoClickListener.accept(getAdapterPosition());
                    }
                }
            });
        }
